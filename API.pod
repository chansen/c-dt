...
The function's behavior is undefined if I<quarter> is out of range. Valid values for 
I<quarter> are 1-4.
...
The function's behavior is undefined if month is out of range. Valid values for 
month are 1-12.
