...
be calculated. If I<start> is earlier than I<end>, then the result is positive. 
If I<start> is later than I<end>, then the result is negative. For example the 
