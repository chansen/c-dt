...
=head2 dt_delta_ymd
    ...
    void dt_delta_ymd(dt_t dt1, dt_t dt2, int *years, int *months, int *days);

Computes the difference between the given dates I<dt1> and I<dt2> in terms of
years, months and days. The result will be negative if I<dt1> is before I<dt2>.
The pointer parameters may be C<NULL> for any of the results that are not required.

=head2 dt_delta_md

    void dt_delta_md(dt_t dt1, dt_t dt2, int *months, int *days);

Computes the difference between the given dates I<dt1> and I<dt2> in terms of 
months and days. The result will be negative if I<dt1> is before I<dt2>. The 
