...
The I<offset> parameter specifies the number of years before (negative) or 
...
The I<offset> parameter specifies the number of quarters before (negative) or 
after (positive) the given date.
...
B<Example:>
    ...
    /* First day of the current quarter last year */
    dt = dt_first_day_of_quarter(dt, -4);
...
The I<offset> parameter specifies the number of months before (negative) or 
after (positive) the given date.
...
I<first_dow> parameter specifies the first day of the week (1=Monday to 7=Sunday).
...
I<offset> parameter specifies the number of years before (negative) or after 
...
I<offset> parameter specifies the number of quarters before (negative) or after 
(positive) the given date.
...
I<offset> parameter specifies the number of months before (negative) or after 
(positive) the given date.
...
B<Example:>
    ...
    /* Monday as the first day of the week implies Sunday as the last */
...
Returns a date set to the I<nth> day of week for given date I<dt>.
...
B<Example:>
    ...
    dt = dt_nth_day_of_week(dt, 3, DT_MONDAY);
    
    /* Memorial Day, the last Monday in May */
    dt = dt_from_ymd(2012, 5, 31);
    dt = dt_nth_day_of_week(dt, -1, DT_MONDAY);
    
    /* Thanksgiving Day, the fourth Thursday in November */
    dt_from_ymd(2012, 11, 1);
    dt = dt_nth_day_of_week(dt, 4, DT_THURSDAY);
    
    /* Penultimate Monday in the second quarter */
    dt = dt_from_yqd(2012, 2, 91);
    dt = dt_nth_day_of_week(dt, -2, DT_MONDAY);
    
    /* 50th Wednesday of the year */
    dt = dt_from_ymd(2012, 1, 1);
    dt = dt_nth_day_of_week(dt, 50, DT_WEDNESDAY);
...
The parameter I<dow> specifies the day of week (1=Monday to 7=Sunday). The 
parameter I<current> specifies whether or not the returned date must succeed
the given date.

B<Example:>

    dt1 = dt_from_ymd(2013, 2, 10);                   /* a Sunday       */
    dt2 = dt_next_day_of_week(dt1, DT_SUNDAY, true);  /* 2013-02-10     */
    dt3 = dt_next_day_of_week(dt1, DT_SUNDAY, false); /* 2013-02-17     */
    dt4 = dt_next_day_of_week(dt1, DT_MONDAY, true);  /* 2013-02-11     */
    dt5 = dt_next_day_of_week(dt1, DT_MONDAY, false); /* 2013-02-11     */
...
I<dt>. The parameter I<dow> specifies the day of week (1=Monday to 7=Sunday).
...
B<Example:>
    ...
    dt1 = dt_from_ymd(2013, 2, 10);                   /* a Sunday       */
    dt2 = dt_prev_day_of_week(dt1, DT_SUNDAY, true);  /* 2013-02-10     */
    dt3 = dt_prev_day_of_week(dt1, DT_SUNDAY, false); /* 2013-02-03     */
    dt4 = dt_prev_day_of_week(dt1, DT_MONDAY, true);  /* 2013-02-04     */
    dt5 = dt_prev_day_of_week(dt1, DT_MONDAY, false); /* 2013-02-04     */
...
B<Example:>
    ...
    dt1 = dt_from_ymd(2013, 2, 10);     /* a Sunday                     */
    dt2 = dt_next_weekday(dt1, true);   /* 2013-02-11                   */
    dt3 = dt_next_weekday(dt1, false);  /* 2013-02-11                   */
    
    dt1 = dt_from_ymd(2013, 2, 15);     /* a Friday                     */
    dt2 = dt_next_weekday(dt1, true);   /* 2013-02-15 (same as input)   */
    dt3 = dt_next_weekday(dt1, false);  /* 2013-02-18                   */
...
B<Example:>
    ...
    dt1 = dt_from_ymd(2013, 2, 10);     /* a Sunday                     */
    dt2 = dt_prev_weekday(dt1, true);   /* 2013-02-08                   */
    dt3 = dt_prev_weekday(dt1, false);  /* 2013-02-08                   */
    
    dt1 = dt_from_ymd(2013, 2, 15);     /* a Friday                     */
    dt2 = dt_prev_weekday(dt1, true);   /* 2013-02-15 (same as input)   */
    dt3 = dt_prev_weekday(dt1, false);  /* 2013-02-14                   */
...
I<adjust> defines the behaviour when the resulting year has one less day 
than the year of the given date.

I<(adjust = DT_EXCESS)> If the resulting year has one less day than the year 
...
I<(adjust = DT_LIMIT)> If the resulting year has one less day than the 
...
resulting year has one less day than the year of the given date, then the result 
...
is later than I<end>, then the result is negative. For example the difference 
between 2011-12-31 and 2012-01-01 is 1.
...
If I<start> is earlier than I<end>, then the result is positive. If I<start> is 
later than I<end>, then the result is negative.
...
If I<start> is earlier than I<end>, then the result is positive. If I<start> 
is later than I<end>, then the result is negative. For example the difference 
between 2012-01-25 and 2012-02-01 is 1; the delta between 2012-01-01 and 
2012-01-31 is 0.
