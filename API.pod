...
Returns the year for the given date C<dt>.
...
Returns a date corresponding to the first day of the year for the 
given date I<dt>. The I<delta> parameter specifies the number of 
...
Returns a date corresponding to the first day of the quarter for the 
given date I<dt>. The I<delta> parameter specifies the number of
...
Returns a date corresponding to the first day of the month for the 
given date I<dt>. The I<delta> parameter specifies the number of 
...
Returns a date corresponding to the first day of the week for the 
given date I<dt>. The I<first_dow> parameter specifies the first 
...
Returns a date corresponding to the last day of the year for the 
given date I<dt>. The I<delta> parameter specifies the number of
years to move forward (positive) or backward (negative).
...
Returns a date corresponding to the last day of the quarter for the 
given date I<dt>. The I<delta> parameter specifies the number of
quarters to move forward (positive) or backward (negative).
...
Returns a date corresponding to the last day of the month for the 
given date I<dt>. The I<delta> parameter specifies the number of
months to move forward (positive) or backward (negative).
...
Returns a date corresponding to the last day of the week for the 
given date I<dt>. The I<first_dow> parameter specifies the first 
day of the week (1=Monday to 7=Sunday).
...
Returns a date corresponding to the I<nth> day of week for given date 
...
Returns a date corresponding to next or current day of week for the given 
...
Returns a date corresponding to previous or current day of week for the given 
date I<dt>. The parameter I<dow> specifies the day of week (1=Monday to 7=Sunday).
...
Returns a date corresponding to next or current weekday (Monday to Friday) for 
...
Returns a date corresponding to previous or current weekday (Monday to Friday) 
...
Returns a date corresponding to I<delta> months added the given date I<dt>.
...
Returns the number of days in the given I<quarter> (90-92) of the given I<year>.
...
Returns the number of days in the given I<month> (28-31) of the given I<year>.
Returns C<0> if the given month is out of range (1-12).

=head1 TEST HARNESS

The test harness is written in Perl and XS. To run the harness:
