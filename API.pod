...
Returns a date value corresponding to Easter Sunday of the given I<year>. The 
...
Returns a date value corresponding to next or current day of week of the given 
...
Returns a date value corresponding to previous or current day of week of the given 
date value I<dt>. The parameter I<dow> specifies the day of week (1=Monday to 7=Sunday).
...
days than the day of the month component of the given date value I<dt>. 

I<(adjust = DT_EXCESS)> If the resulting month has fewer days than the day of 
month component of the given date value I<dt>, then the result is counted 
forward or backward into the next or previous month by the number of excessive 
days. Otherwise, the result has the same day of month component as given date 
value I<dt>. For example:
...
month component of the given date value I<dt>, then the result is the last day 
of the resulting month. Otherwise, the result has the same day of month 
component as given date value I<dt>. For example:
...
of the given date value I<dt>, then the result is the last day of the resulting 
month. Otherwise, the result has the same day of month component as given date 
value I<dt>. For example:
