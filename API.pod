...
Returns the number of days in the given I<quarter> (90-92) of the given year I<year>.

=head2 dt_days_in_month

    int dt_days_in_month(int year, int month);

Returns the number of days in the given I<month> (28-31) of the given year I<year>.
