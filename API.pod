...
B<Example:>
    ...
    dt = dt_from_yd(2012, 1);   /* 2012-001 */
    dt = dt_from_yd(2012, 0);   /* 2011-365 */
    dt = dt_from_yd(2012, -1);  /* 2011-364 */
...
=head2 dt_nth_day_of_week
    ...
    dt_t dt_nth_day_of_week(dt_t dt, int nth, int day);
...
dates I<start> and I<end>. The parameter I<inclusive> specifies whether or 
not the the I<end> date should be inclusive. If I<start> is earlier than 
I<end>, then the result is positive. If I<start> is later than I<end>, 
