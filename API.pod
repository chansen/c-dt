...
The I<offset> parameter specifies the number of years to move forward (positive) 
...
The I<offset> parameter specifies the number of quarters to move forward (positive) 
or backward (negative).
...
The I<offset> parameter specifies the number of months to move forward (positive) 
or backward (negative).
...
I<offset> parameter specifies the number of years to move forward (positive) 
or backward (negative).
...
I<offset> parameter specifies the number of quarters to move forward (positive) 
or backward (negative).
...
I<offset> parameter specifies the number of months to move forward (positive) 
or backward (negative).
...
Returns a date set to the previous or current day of week for the given 
...
Returns a date with the given I<years> added. The parameter I<adjust> 
defines the behaviour when the resulting year has one less day than the 
...
Returns a date with the given I<quarters> added. The parameter I<adjust> 
defines the behaviour when the resulting quarter has fewer days than the day 
...
Returns a date with the given I<months> added. The parameter I<adjust> 
defines the behaviour when the resulting month has fewer days than the day 
...
If I<start> is later than I<end>, then the result is negative. The pointer 
parameters may be C<NULL> for any of the results that are not required.
...
pointer parameters may be C<NULL> for any of the results that are not required.
...
is later than I<end>, then the result is negative. For example the delta 
